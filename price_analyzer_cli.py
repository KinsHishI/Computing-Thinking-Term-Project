...
class Visualizer:
    ...
    def save_histogram(
        self, prices: List[int], keyword: str, filename: str = "price_histogram.png"
    ):
        """
...
def interactive_mode():
    ...
    print("\n" + "╔" + "=" * 58 + "╗")
    print("║" + " " * 58 + "║")
    print("║" + "  상품 가격 분석 및 추적 시스템 (CLI 버전)".center(58) + "║")
    print("║" + " " * 58 + "║")
    print("╚" + "=" * 58 + "╝")
    ...
    while True:
        ...
        if choice == "1":
            ...
            try:
                ...
                if save == "y":
                    data = {"keyword": keyword, "prices": prices, "statistics": stats}
