...
class PriceAnalyzerGUI:
    ...
    def __init__(self, root: tk.Tk):
        self.root = root
        self.root.title("지능형 상품 가격 분석 및 추적 시스템")
    ...
    def _setup_gui(self):
        ...
        tk.Label(top_frame, text="검색 키워드:", font=("Arial", 12)).pack(side=tk.LEFT, padx=5)
        ...
        tk.Label(middle_frame, text="수집 결과 및 통계:", font=("Arial", 11, "bold")).pack(anchor=tk.W)
    ...
    def start_collection(self):
        ...
        self.result_text.insert(tk.END, "데이터를 수집하고 있습니다. 잠시만 기다려주세요...\n\n")
    ...
    def _update_results(self, prices: List[int]):
        ...
        if not prices:
            ...
            self.result_text.insert(tk.END, f"가격 범위: {stats['max'] - stats['min']:,}원\n")
            self.result_text.insert(tk.END, "-" * 60 + "\n\n")
    ...
    def save_results(self):
        ...
        try:
            ...
            messagebox.showinfo("성공", f"결과가 '{saved_filename}' 파일로 저장되었습니다.")
        except Exception as e:
