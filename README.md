...
- 🌐 **Flask 웹 대시보드** - 브라우저에서 사용 가능한 웹 인터페이스 (NEW! v1.2) ⭐
...
- ✅ **실시간 분석**: 브라우저에서 즉시 검색하고 결과 확인
- ✅ **인터랙티브 차트**: Chart.js를 활용한 동적 히스토그램
- ✅ **검색 히스토리**: 최근 검색 결과 자동 저장 및 불러오기
- ✅ **REST API**: JSON 기반 API로 확장 가능
- ✅ **별도 설치 불필요**: 브라우저만 있으면 OK!

**자세한 사용법**: [WEB_DASHBOARD_GUIDE.md](WEB_DASHBOARD_GUIDE.md) 참고

### 방법 2: GUI 버전 (권장 - macOS 최신 버전)
```bash
